...
class CutoutFilter(Filter):
    def __init__(self, logger : Logger, threshold : float = 0.5, name : str = "output"):
    ...
    def apply(self, data : dict):
        ...
        self.logger.info(f"OutputFilter: Found {len(masks)} masks with scores.")
        ...
        self.logger.info(f"OutputFilter: Found {len(images)} images with score above {self.threshold}.")
